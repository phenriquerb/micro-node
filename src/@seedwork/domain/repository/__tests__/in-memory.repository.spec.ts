...
describe("InMemoryRepository Unit Tests",  () => {
    ...
    it('should throws error when entity not found', () => {
       expect(repository.findById('fake id')).rejects.toThrow(
        ...
        expect(repository.findById('9366b7dc-2d71-4799-b91c-c64adb205104')).rejects.toThrow(
    ...
    it('should throws error on delete when entity not found', () => {
        ...
        expect(repository.delete('9366b7dc-2d71-4799-b91c-c64adb205104')).rejects.toThrow(
            new NotFoundError( `Entity Not Found using ID 9366b7dc-2d71-4799-b91c-c64adb205104`)
        );
    });
